...
export default {
  ...
  methods: {
    ...
    removeActiveClass() {
      ...
      if (localStorage.getItem("background_option") !== null) {
        if (localStorage.getItem("background_option") == "true") {
          ...
          /* eslint-disable */console.log(...oo_oo(`3915369681_99_10_99_54_4`,"random", this.randomBackground));
        } else {
          this.randomBackground = false;
          /* eslint-disable */console.log(...oo_oo(`3915369681_102_10_102_54_4`,"random", this.randomBackground));
        }
        /* eslint-disable */console.log(...oo_oo(`3915369681_104_8_104_72_4`,"random", localStorage.getItem("background_option")));
      }
    ...
    changeColor(color) {
      ...
      /* eslint-disable */console.log(...oo_oo(`3915369681_134_6_134_72_4`,"local storage", localStorage.getItem("color_option")));
    },
    // change Background
...
.contact {
  min-height: 600px;
  // background-image: url("../assets/images/images/contact.png");
  background-size: cover;
  padding-top: 80px;
  padding-bottom: 80px;
  position: relative;
